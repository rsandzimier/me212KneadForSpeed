...
set_ros()
{
  ...
  if [ -f $CODE_BASE/devel/setup.bash ]; then
    source $CODE_BASE/devel/setup.bash
  else
...
alias pythonpokebot='ipython -i -c "run $CODE_BASE/src/pokebot_config/python/pythonpokebot.py"'
